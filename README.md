...
<img src='HobbyHub/src/assets/demo.gif' width="400px" title='Video Walkthrough' width='' alt='Video Walkthrough' />
<!-- Replace this with whatever GIF tool you used! -->
GIF created with Imgur(https://i.imgur.com/JGfxtjg.gif)
<!-- Recommended tools:
